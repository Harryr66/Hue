  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "duration-200 fixed inset-y-0 z-20 hidden h-svh w-[--sidebar-width-icon] transition-[left,right,width] ease-linear md:flex",
            "group-data-[state=expanded]:w-[--sidebar-width]",
            side === "left"
...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      {...props}
    >
      {state === 'expanded' ? <ChevronLeft /> : <PanelLeft />}
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "group-data-[state=collapsed]:[&>*:first-child>*:last-child]:hidden",
        className
      )}
      {...props}
    />
